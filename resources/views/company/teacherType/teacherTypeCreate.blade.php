...
<div class="container-fluid mt-4">
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="card">
        <form action="/company/teacherType/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
          @csrf
          <div class="card-header">
            <h3 class="mb-0">添加教师评级</h3>
          </div>
          <!-- Card body -->
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-hover text-center table-bordered">
                <tbody>
                  ...
                  <td style='width:400px;'><input class="form-control" type="text" name="input_teacher_type_name" placeholder="请输入教师评级名称..." autocomplete='off' required maxlength="10"></td>
                </tbody>
              </table>
              <table class="table table-hover text-center table-bordered">
                ...
                <tbody>
                  @foreach ($grades as $grade)
                    <tr>
                      ...
                      @for ($i = 1; $i <= 6; $i++)
                        <td><input class="form-control form-control form-control-sm" name="input_{{$grade->grade_id}}_{{$i}}" type="number" value="0" min='0' required></td>
                      @endfor
                    </tr>
                  @endforeach
                </tbody>
