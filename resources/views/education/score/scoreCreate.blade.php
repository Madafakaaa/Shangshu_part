            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="input_score_subject" data-toggle="select" required>
              ...
              <div class="col-6">
                <div class="form-group">
                  <label class="form-control-label">考试分数<span style="color:red">*</span></label>
                  <input class="form-control" type="number" name="input_score_mark" placeholder="考试分数..." min="0" max="200" required>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
