...
@section('nav')
<h2 class="text-white d-inline-block mb-0">教务评分</h2>
<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
    ...
    <li class="breadcrumb-item active">教务评分</li>
  </ol>
</nav>
@endsection
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body p-0">
          <form action="/teacher/assessment/staff/store" method="post" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
            @csrf
