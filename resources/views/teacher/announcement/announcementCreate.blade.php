...
@section('nav')
<h2 class="text-white d-inline-block mb-0">添加通知</h2>
<nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
    <li class="breadcrumb-item"><a href="/home"><i class="fas fa-home"></i></a></li>
    <li class="breadcrumb-item active">教师中心</li>
    <li class="breadcrumb-item"><a href="/teacher/announcement">通知管理</a></li>
    <li class="breadcrumb-item active">添加通知</li>
  </ol>
</nav>
@endsection
...
<div class="container-fluid mt-4">
  <div class="row justify-content-center">
    <div class="col-lg-6 col-md-9 col-sm-12 card-wrapper ct-example">
      <div class="card">
        <form action="/teacher/announcement/store" method="post" enctype="multipart/form-data" id="form1" name="form1" onsubmit="submitButtonDisable('submitButton1')">
          @csrf
          <div class="card-header">
            <h3 class="mb-0">添加通知</h3>
          </div>
          <!-- Card body -->
          <div class="card-body">
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  ...
                  <select class="form-control" name="announcement_level" data-toggle="selectNoFilter" required>
                    ...
                    <option value='5'>全部可见</option>
                    <option value='4'>教务及已上可见</option>
                    <option value='3'>分校长及已上可见</option>
                  </select>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <div class="form-group">
                  <label class="form-control-label">通知文件<span style="color:red">*</span></label>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-5 col-sm-12">
                <a href="/teacher/announcement" ><button type="button" class="btn btn-outline-primary btn-block">返回</button></a>
              </div>
